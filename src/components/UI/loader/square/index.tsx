  ...
  return (
    <>
      ...
      >
        ...
        <path
          d="M7 8H3V16H7V8Z"
          className="animate animate-bounce fill-blue-900 "
        />
        <path
          d="M14 8H10V16H14V8Z"
          className="animate animate-bounce fill-blue-900 [animation-delay:.2s]"
        />
        <path
          d="M21 8H17V16H21V8Z"
          className="animate animate-bounce fill-blue-900 [animation-delay:.4s]"
        />
      </svg>
